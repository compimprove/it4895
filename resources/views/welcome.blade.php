@php
    ...
    $allApiName = [
        ...
        "add_post", "get_post", "delete_post", //"get_list_posts", "edit_post"
        "get_comment", "set_comment",
        "report_post", "like_post",
        // search, get_saved_search, del_saved_search
        "get_user_friends", "get_user_info",
        "set_user_info",
        //"get_list_videos","check_new_version","get_conversation","delete_message", "get_list_conversation", "delete_conversation","check_new_item","set_read_message",
