...
Route::middleware(['attach-token', 'auth:sanctum', 'user-blocked', 'validate-response'])->group(function () {
    ...
    Route::get('/get_notification', "UserController@getNotifications")->name("get_notification");
    Route::post('/set_read_notification', "UserController@setReadNotification")->name("set_read_notification");
    Route::get('/get_push_settings', "SettingsController@getPushSetting")->name("get_push_settings");
    Route::get('/get_requested_friends', "UserController@getRequestedFriends")->name("get_requested_friends");
    Route::post('/set_request_friend', "UserController@setRequestFriends")->name("set_request_friend");
    Route::get('/get_user_friends', "UserController@getFriends")->name("get_user_friends");
    Route::get('/get_list_suggested_friends', "UserController@getSuggestedFriends")->name("get_list_suggested_friends");
    ...
    Route::get("/get_list_blocks", "UserController@getBlock")->name("get_list_blocks");
    Route::get("/get_user_info", "UserController@getInfo")->name("get_user_info");
    ...
    Route::get('/get_list_conversation', 'ChatController@getListConversation')->name("get_list_conversation");
    Route::get('/get_conversation', 'ChatController@getConversation')->name("get_conversation");
    ...
    Route::get('/get_comment', 'CommentController@getComment')->name("get_comment");
